...
replace (
	github.com/projectdiscovery/interactsh v0.0.7 => github.com/0x4E0x650x6F/interactsh v0.0.7
	github.com/projectdiscovery/interactsh v1.0.6 => github.com/0x4E0x650x6F/interactsh v0.0.8-0.20220810161238-3f96fd061a09
)
