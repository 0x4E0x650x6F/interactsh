...
replace github.com/projectdiscovery/interactsh v0.0.7 => github.com/0x4E0x650x6F/interactsh v0.3.7

replace github.com/projectdiscovery/interactsh/pkg/server v0.0.7 => github.com/0x4E0x650x6F/interactsh/pkg/server v0.3.7
